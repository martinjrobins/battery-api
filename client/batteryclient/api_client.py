...
from batteryclient import rest
from batteryclient.configuration import Configuration
from batteryclient.exceptions import ApiTypeError, ApiValueError, ApiException
from batteryclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_cell  # this is an instance of the class Endpoint
        api_instance.get_cell()  # this invokes api_instance.get_cell.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_cell.callable or self.callable in this class
