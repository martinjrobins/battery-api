...
class Dataset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'ranges': ([Range],),  # noqa: E501
            'json_data': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            equipment ([Equipment]): [optional]  # noqa: E501
            ranges ([Range]): [optional]  # noqa: E501
            json_data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, date, *args, **kwargs):  # noqa: E501
        """Dataset - a model defined in OpenAPI
